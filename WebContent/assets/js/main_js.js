...
$('#btnLike').on('click', function(){
	...
	$.ajax({
		method: "POST",
		url: "${pageContext.servletContext.contextPath}/singlePostView.jsp",
		data: { flag: flag}
	})
	.done(function(msg){
		isLike=!isLike;
		if(isLike){
			$('#btnLike').css('background', 'url("assets/icons/like5.png" ) no-repeat');
		}else{
			$('#btnLike').css('background', 'url("assets/icons/like6.png" ) no-repeat');
		}
