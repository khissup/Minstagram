...
<div class="content-area">
    ...
    <%
        for(int i=0; i<postList.size(); i++){
            ...
            like_post.put(post.getId(), isLiking);
    %>
    <div class="post-box">
        <p class="post-top">
        ...
        <%
            ...
            %>
            <a href="${pageContext.request.contextPath}/likePost/unlikePost_4.jsp?user_id=<%=memId%>&post_id=<%=postId%>">
            ...
            %>
            <a href="${pageContext.request.contextPath}/likePost/likePost_4.jsp?user_id=<%=memId%>&post_id=<%=postId%>">
