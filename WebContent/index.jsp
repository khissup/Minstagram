...
%>
    <div class="post-box">
        ...
        <%
            ...
            %>
            <a href="${pageContext.request.contextPath}/likePost/unlikePost_1.jsp?user_id=<%=memId%>&post_id=<%=postId%>">
            ...
            %>
            <a href="${pageContext.request.contextPath}/likePost/likePost_1.jsp?user_id=<%=memId%>&post_id=<%=postId%>">
